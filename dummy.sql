...
VALUES
	('11111111-2222-3333-4444-aaaa00000001', '11111111-2222-3333-4444-555555555555', 'admin-full-access', 'Admin Full Access', 'Controle total de todas as áreas da academia', 'ALLOW', ARRAY['create', 'read', 'update', 'delete', 'manage'], ARRAY['members', 'classes', 'payments', 'equipment', 'competitions', 'reports', 'settings', 'users'], '{"scope": "global"}'::jsonb, NOW()),
	('11111111-2222-3333-4444-aaaa00000002', '11111111-2222-3333-4444-555555555555', 'management-access', 'Management Access', 'Gestão executiva sem acesso a configurações críticas', 'ALLOW', ARRAY['create', 'read', 'update', 'delete'], ARRAY['members', 'classes', 'payments', 'competitions', 'reports'], '{"scope": "management"}'::jsonb, NOW()),
	('11111111-2222-3333-4444-aaaa00000003', '11111111-2222-3333-4444-555555555555', 'financial-access', 'Financial Access', 'Gestão de cobranças e finanças', 'ALLOW', ARRAY['create', 'read', 'update'], ARRAY['payments', 'reports', 'members'], '{"department": "finance"}'::jsonb, NOW()),
	...
	('11111111-2222-3333-4444-aaaa00000005', '11111111-2222-3333-4444-555555555555', 'reception-access', 'Reception Access', 'Atendimento e cadastros de alunos', 'ALLOW', ARRAY['create', 'read'], ARRAY['members', 'classes', 'payments', 'schedules', 'basic_reports'], '{"department": "frontdesk"}'::jsonb, NOW()),
	('11111111-2222-3333-4444-aaaa00000006', '11111111-2222-3333-4444-555555555555', 'operations-access', 'Operations Access', 'Suporte administrativo interno', 'ALLOW', ARRAY['read', 'update'], ARRAY['members', 'classes', 'equipment'], '{"department": "operations"}'::jsonb, NOW()),
	('11111111-2222-3333-4444-aaaa00000007', '11111111-2222-3333-4444-555555555555', 'equipment-maintenance', 'Equipment Maintenance', 'Manutenção e estoque de equipamentos', 'ALLOW', ARRAY['create', 'read', 'update', 'delete'], ARRAY['equipment', 'inventory'], '{"department": "maintenance"}'::jsonb, NOW()),
	('11111111-2222-3333-4444-aaaa00000008', '11111111-2222-3333-4444-555555555555', 'security-access', 'Security Access', 'Controle de acesso e incidentes', 'ALLOW', ARRAY['read'], ARRAY['members', 'classes', 'access_logs', 'facilities'], '{"department": "security"}'::jsonb, NOW()),
	('11111111-2222-3333-4444-aaaa00000009', '11111111-2222-3333-4444-555555555555', 'member-vip-access', 'Member VIP Access', 'Benefícios de membros VIP', 'ALLOW', ARRAY['read'], ARRAY['members', 'classes', 'competitions', 'perks'], '{"tier": "vip"}'::jsonb, NOW()),
	('11111111-2222-3333-4444-aaaa0000000a', '11111111-2222-3333-4444-555555555555', 'member-basic-access', 'Member Basic Access', 'Acesso essencial dos alunos regulares', 'ALLOW', ARRAY['read'], ARRAY['members', 'classes', 'competitions'], '{"tier": "regular"}'::jsonb, NOW()),
	('66666666-7777-8888-9999-aaaa00000001', '66666666-7777-8888-9999-aaaaaaaaaaaa', 'admin-full-access', 'Admin Full Access', 'Controle total sobre todas as unidades da rede', 'ALLOW', ARRAY['create', 'read', 'update', 'delete', 'manage'], ARRAY['members', 'classes', 'payments', 'equipment', 'competitions', 'reports', 'settings', 'users'], '{"scope": "global"}'::jsonb, NOW()),
	('66666666-7777-8888-9999-aaaa00000002', '66666666-7777-8888-9999-aaaaaaaaaaaa', 'management-access', 'Management Access', 'Gestão das filiais e rotinas operacionais', 'ALLOW', ARRAY['create', 'read', 'update', 'delete'], ARRAY['members', 'classes', 'payments', 'competitions', 'reports'], '{"scope": "management"}'::jsonb, NOW()),
	('66666666-7777-8888-9999-aaaa00000003', '66666666-7777-8888-9999-aaaaaaaaaaaa', 'financial-access', 'Financial Access', 'Controle financeiro consolidado da rede', 'ALLOW', ARRAY['create', 'read', 'update'], ARRAY['payments', 'reports', 'members'], '{"department": "finance"}'::jsonb, NOW()),
	...
	('66666666-7777-8888-9999-aaaa00000005', '66666666-7777-8888-9999-aaaaaaaaaaaa', 'reception-access', 'Reception Access', 'Atendimento integrado ao CRM da rede', 'ALLOW', ARRAY['create', 'read'], ARRAY['members', 'classes', 'payments', 'schedules', 'basic_reports'], '{"department": "frontdesk"}'::jsonb, NOW()),
	('66666666-7777-8888-9999-aaaa00000006', '66666666-7777-8888-9999-aaaaaaaaaaaa', 'operations-access', 'Operations Access', 'Suporte administrativo compartilhado', 'ALLOW', ARRAY['read', 'update'], ARRAY['members', 'classes', 'equipment'], '{"department": "operations"}'::jsonb, NOW()),
	('66666666-7777-8888-9999-aaaa00000007', '66666666-7777-8888-9999-aaaaaaaaaaaa', 'equipment-maintenance', 'Equipment Maintenance', 'Logística de equipamento por unidade', 'ALLOW', ARRAY['create', 'read', 'update', 'delete'], ARRAY['equipment', 'inventory'], '{"department": "maintenance"}'::jsonb, NOW()),
	('66666666-7777-8888-9999-aaaa00000008', '66666666-7777-8888-9999-aaaaaaaaaaaa', 'security-access', 'Security Access', 'Monitoramento de acesso entre unidades', 'ALLOW', ARRAY['read'], ARRAY['members', 'classes', 'access_logs', 'facilities'], '{"department": "security"}'::jsonb, NOW()),
	('66666666-7777-8888-9999-aaaa00000009', '66666666-7777-8888-9999-aaaaaaaaaaaa', 'member-vip-access', 'Member VIP Access', 'Acesso vip multiunidade', 'ALLOW', ARRAY['read'], ARRAY['members', 'classes', 'competitions', 'perks'], '{"tier": "vip"}'::jsonb, NOW()),
	('66666666-7777-8888-9999-aaaa0000000a', '66666666-7777-8888-9999-aaaaaaaaaaaa', 'member-basic-access', 'Member Basic Access', 'Acesso regular às unidades cadastradas', 'ALLOW', ARRAY['read'], ARRAY['members', 'classes', 'competitions'], '{"tier": "regular"}'::jsonb, NOW()),
	('bbbbbbbb-cccc-dddd-eeee-aaaa00000001', 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'admin-full-access', 'Admin Full Access', 'Controle total da academia boutique', 'ALLOW', ARRAY['create', 'read', 'update', 'delete', 'manage'], ARRAY['members', 'classes', 'payments', 'equipment', 'competitions', 'reports', 'settings', 'users'], '{"scope": "global"}'::jsonb, NOW()),
	('bbbbbbbb-cccc-dddd-eeee-aaaa00000002', 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'management-access', 'Management Access', 'Curadoria da experiência premium', 'ALLOW', ARRAY['create', 'read', 'update', 'delete'], ARRAY['members', 'classes', 'payments', 'competitions', 'reports'], '{"scope": "management"}'::jsonb, NOW()),
	('bbbbbbbb-cccc-dddd-eeee-aaaa00000003', 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'financial-access', 'Financial Access', 'Gestão de pacotes premium e faturamento', 'ALLOW', ARRAY['create', 'read', 'update'], ARRAY['payments', 'reports', 'members'], '{"department": "finance"}'::jsonb, NOW()),
	...
	('bbbbbbbb-cccc-dddd-eeee-aaaa00000005', 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'reception-access', 'Reception Access', 'Atendimento concierge dos membros', 'ALLOW', ARRAY['create', 'read'], ARRAY['members', 'classes', 'payments', 'schedules', 'basic_reports'], '{"department": "frontdesk"}'::jsonb, NOW()),
	('bbbbbbbb-cccc-dddd-eeee-aaaa00000006', 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'operations-access', 'Operations Access', 'Backoffice e suporte ao cliente', 'ALLOW', ARRAY['read', 'update'], ARRAY['members', 'classes', 'equipment'], '{"department": "operations"}'::jsonb, NOW()),
	('bbbbbbbb-cccc-dddd-eeee-aaaa00000007', 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'equipment-maintenance', 'Equipment Maintenance', 'Manutenção de equipamentos premium', 'ALLOW', ARRAY['create', 'read', 'update', 'delete'], ARRAY['equipment', 'inventory'], '{"department": "maintenance"}'::jsonb, NOW()),
	('bbbbbbbb-cccc-dddd-eeee-aaaa00000008', 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'security-access', 'Security Access', 'Controle de acesso dos espaços exclusivos', 'ALLOW', ARRAY['read'], ARRAY['members', 'classes', 'access_logs', 'facilities'], '{"department": "security"}'::jsonb, NOW()),
	('bbbbbbbb-cccc-dddd-eeee-aaaa00000009', 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'member-vip-access', 'Member VIP Access', 'Benefícios exclusivos para membros VIP', 'ALLOW', ARRAY['read'], ARRAY['members', 'classes', 'competitions', 'perks'], '{"tier": "vip"}'::jsonb, NOW()),
	('bbbbbbbb-cccc-dddd-eeee-aaaa0000000a', 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'member-basic-access', 'Member Basic Access', 'Acesso padrão dos membros essenciais', 'ALLOW', ARRAY['read'], ARRAY['members', 'classes', 'competitions'], '{"tier": "regular"}'::jsonb, NOW())
ON CONFLICT DO NOTHING;
...
WITH role_permissions AS (
	...
	FROM UNNEST(ARRAY['members', 'classes', 'payments', 'equipment', 'competitions', 'reports', 'settings', 'users']) AS resources(resource)
